  ...
  zh: {
    ...
    pages: {
      competition: {
        ...
        title: "电赛项目体系",
        description: "这部分记录我参加电赛时做过的硬件。从 2026 AC-AC 整机，到隔离采样、辅助电源、STM32G4 控制板和功率板，都是能单独拿出来调试的实物。",
        back: "返回首页"
      },
      personal: {
    ...
    projectDetail: {
      ...
      imagesTitle: "实物、波形和图纸",
      openImage: "查看高清原图",
      responsibilities: "我的职责",
      metrics: "技术指标",
      keyComponents: "主要器件与参数",
      operatingPrinciples: "工作原理",
      engineeringHighlights: "硬件实现",
