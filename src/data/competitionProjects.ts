...
export const competitionProjects: PortfolioProject[] = [
  {
    ...
    summary: "2026 年全国大学生电子设计竞赛 AC-AC 变换电路项目：以 36V / 50Hz 单相交流为赛题输入，前级采用四开关图腾柱无桥 PFC 完成功率因数校正与直流母线建立，后级采用三相全桥并由团队软件通过 SVPWM 生成三相对称交流输出。项目获得省级二等奖。",
    image: "images/contest-2026-three-phase-waveform.jpg",
    detailImages: [
      {
        src: "images/contest-2026-system-bench.jpg",
        title: "AC-AC 系统完整接线与实验台",
        description: "完整调试现场包含图腾柱无桥 PFC、三相全桥、控制与采样模块、滤波网络、保护接线及测试仪器，用于分模块上电和整机联调。",
        kind: "prototype"
      },
      {
        src: "images/contest-2026-system-waveform-bench.jpg",
        title: "功率板、控制板与三相波形联合调试",
        description: "控制板、PFC 与逆变功率板在同一平台完成联合调试，示波器同步观察三相对称输出波形。",
        kind: "prototype"
      },
      {
        src: "images/contest-2026-pfc-power-meter.jpg",
        title: "低压单相输入侧功率分析记录",
        description: "功率分析仪屏显 33.319Vrms、3.9074Arms、128.73W 与 PF 0.989；该照片仅作为这一调试工况下的输入侧实测记录。",
        kind: "test"
      },
      {
        src: "images/contest-2026-mains-test-setup.jpg",
        title: "市电调压、隔离与断路保护装备",
        description: "市电先经过调压器、隔离变压器与断路保护，再形成赛题要求的低压单相交流输入；调试过程按限流、隔离和分阶段上电执行。",
        kind: "test"
      },
      {
        src: "images/contest-2026-three-phase-waveform.jpg",
        title: "三相对称交流输出波形",
        description: "示波器记录约 49.98Hz 的三相对称波形，作为逆变链路联合调试证据；该记录不替代赛题规定的 30Hz / 60Hz 验收工况。",
        kind: "waveform"
      }
    ],
    tags: ["图腾柱无桥 PFC", "三相全桥", "SVPWM", "AC-AC", "省级二等奖"],
    status: "已完赛｜2026 年全国大学生电子设计竞赛省级二等奖",
    goal: "完成一套由单相低压交流输入到三相对称交流输出的 AC-AC 变换系统，在图腾柱无桥 PFC、直流母线与三相全桥之间建立清晰的功率、采样、驱动和保护接口，并通过模块化硬件与团队协作在竞赛周期内完成整机交付。",
    quickOverview: {
      objective: "实现 36V / 50Hz 单相交流输入到三相对称交流输出的竞赛 AC-AC 变换系统。",
      challenge: "需要在有限赛程内同时完成图腾柱 PFC、三相全桥、隔离驱动与采样保护，并协调硬件和 SVPWM 软件的接口联调。",
      contribution: "担任队长，主导总体架构、技术路线、团队人员调配和联调节奏；独立负责全部硬件，SVPWM 与控制软件由队友完成。",
      outcome: "完成整机接线与联合调试，留下 PF 0.989 和三相波形等现场证据，项目获得省级二等奖。"
    },
    responsibilities: [
      "担任队长，确定图腾柱无桥 PFC、直流母线、三相全桥和控制系统之间的总体架构与技术路线。",
      "负责团队人员调配、任务拆解、模块接口约束、上电顺序和整机联调节奏，保证硬件与软件按统一信号定义协同。",
      "独立负责全部硬件工作，包括四开关图腾柱无桥 PFC、三相全桥、隔离驱动、采样、保护、母线、滤波、接线与硬件调试。",
      "规划市电调压、隔离、断路保护和低压限流调试路径，按辅助电源、驱动、采样、单桥臂、PFC、三相逆变的顺序分阶段验证。",
      "组织功率分析仪和示波器测试，核对 PFC 输入侧功率因数、三相相序、对称性、频率及整机运行状态。",
      "SVPWM 和控制软件由队友完成；本人负责硬件接口、功率级约束与联合调试，未参与软件代码实现。"
    ],
    metrics: [
    ...
    keyComponents: [
      { label: "输入与安全边界", value: "调压 + 隔离 + 断路保护", note: "市电经调压和隔离后形成赛题要求的低压单相交流输入。" },
      { label: "PFC 功率级", value: "四开关图腾柱无桥", note: "通过两组半桥完成正负半周换流、电流整形和直流母线建立。" },
      { label: "直流母线", value: "储能 + 采样 + 保护", note: "连接 PFC 与逆变级，并承担低频功率脉动缓冲及过压监测。" },
      { label: "逆变功率级", value: "三相全桥", note: "三个桥臂产生三相 PWM 电压，经输出滤波后驱动三相阻性负载。" },
      { label: "调制方式", value: "SVPWM", note: "由队友完成控制软件；硬件侧提供六路驱动、采样、保护和接口约束。" },
      { label: "调试仪器", value: "功率分析仪 + 示波器", note: "分别记录输入功率因数和三相输出波形。" }
    ],
    operatingPrinciples: [
      "市电经调压器、隔离变压器与断路保护转换为赛题规定的 36V / 50Hz 低压单相交流，先建立安全、可分阶段验证的输入边界。",
      "四开关图腾柱无桥 PFC 在正负半周使用不同桥臂完成高频电流调制与工频换向，使输入电流跟随输入电压并向直流母线传递能量。",
      "直流母线为前后级提供能量解耦，母线电压、电流和故障信号通过采样与保护链路送入控制系统。",
      "三相全桥由三个桥臂构成，团队控制软件使用 SVPWM 计算六路开关状态；硬件驱动负责隔离、电平转换、死区执行条件和功率器件可靠开关。",
      "三相 PWM 电压经输出滤波形成相位互差 120° 的对称交流波形，再接入三相阻性负载完成系统验证。"
    ],
    engineeringHighlights: [
      "前级采用四开关图腾柱无桥 PFC，减少传统整流桥导通路径，并把功率因数校正与母线建立整合为统一前级。",
      "PFC、母线、三相全桥、驱动、采样和控制接口按模块划分，便于竞赛现场快速替换、分段定位和并行调试。",
      "队长统一硬件边界与软件接口：明确六路 PWM、采样比例、保护极性、故障锁存和上电状态，降低团队并行开发的集成风险。",
      "调试链路从隔离低压、单模块和单桥臂逐步推进到 PFC 与三相逆变联合运行，避免直接整机上电扩大故障范围。",
      "功率分析仪与三相波形照片分别保留输入侧和输出侧证据，展示系统从交流输入到三相交流输出的完整功率链路。"
    ],
    diagramTitle: "图腾柱 PFC 与三相逆变 AC-AC 系统链路",
    diagramNodes: ["市电调压 / 隔离", "36V / 50Hz 单相输入", "四开关图腾柱无桥 PFC", "直流母线", "三相全桥", "SVPWM + 输出滤波", "三相阻性负载"],
    designPoints: [
      "赛题基本工况为 36V / 50Hz 单相输入，三相线电压 32V±0.1V、输出频率 60Hz±0.2Hz、线电流 2A；另需覆盖 32V / 30Hz / 2A 调节工况。",
      "PF≥0.98、效率≥95%、输出线电压 THD≤2%、负载调整率和输入电压调整率≤0.3%均作为赛题设计目标展示，不在缺少对应测试记录时表述为已全部实测达成。",
      "图腾柱 PFC 四个开关器件需兼顾高频调制、工频换向、死区和过零区控制，硬件驱动、采样方向与保护逻辑必须和控制状态保持一致。",
      "三相全桥的六路驱动按桥臂建立互锁与默认关断状态，硬件接口允许软件通过 SVPWM 组合有效矢量和零矢量，同时防止同桥臂直通。",
      "整机接线把高 di/dt 功率回路、驱动回路、模拟采样和数字控制分区，并保留母线、桥臂、采样和故障测试点。"
    ],
    progress: "已完成总体方案、全部硬件、模块化接线、分阶段上电与整机联合调试；团队完成 SVPWM 控制软件并接入硬件平台。现场记录显示输入侧 PF 0.989 和约 49.98Hz 三相对称波形，项目最终获得省级二等奖。",
    validation: [
      "整机证据：完成 PFC、三相全桥、控制板、采样驱动、滤波与保护模块的完整接线和联合运行。",
      "输入侧记录：功率分析仪在照片所示工况下显示 33.319Vrms、3.9074Arms、128.73W、PF 0.989。",
      "输出侧记录：示波器观察到相位依次错开的三相对称交流波形，照片中频率约 49.98Hz。",
      "安全链路：调压器、隔离变压器和断路保护共同建立低压输入，调试过程采用限流与分阶段上电。",
      "口径边界：现有照片不单独证明效率、THD、负载调整率和输入电压调整率全部达标，因此这些数值仅保留为赛题设计目标。"
    ],
    improvements: [
      "以队长身份完成总体架构、硬件交付与团队协同，项目获得 2026 年全国大学生电子设计竞赛省级二等奖。",
      "沉淀图腾柱无桥 PFC、直流母线和三相全桥可复用硬件链路，可继续用于电机驱动、逆变电源和 AC-AC 变换实验。",
      "形成包含调压隔离、分模块上电、桥臂检查、保护确认、PFC 测试和三相波形核对的竞赛现场调试流程。",
      "后续如补充正式测试表，可继续加入 30Hz / 60Hz、2A 负载、效率、THD 与调整率的分工况数据，不改变当前证据分层口径。"
    ]
  },
  {
